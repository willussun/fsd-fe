...
export class UpdateCompanyComponent implements OnInit {
  ...
  public deactivate(id: number) {
    ...
    // var params = new HttpParams().set("status","0");
    this._http.post<any[]>('/stock-module/companies/deactivate/' + id, httpOptions).subscribe(data => {
      this.result = data;
      console.log("printing this deactivate result...");
      console.log(data);
    }
    );
  ...
  public activate(id: number) {
    ...
    // var params = new HttpParams().set("status","0");
    this._http.post<any[]>('/stock-module/companies/activate/' + id, httpOptions).subscribe(data => {
      this.result = data;
      console.log("printing this activate result...");
      console.log(data);
    }
    );
  ...
  public onSearch() {
    ...
    this.router.navigate(['/admin/update-company'], navigationExtras);
    // this.router.navigate(['/admin/update-company/', this.searchKeyword]);
  }
}
